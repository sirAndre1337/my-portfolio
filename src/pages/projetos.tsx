    ...
    return (
        <Layout>
            <div className='md:flex justify-center text-center p-6 hidden'>
                <p className='p-4 bg-white/50 dark:bg-white/10 rounded-md w-full flex items-center justify-center gap-4'>Projetos/Estudos que estão online. <IoWifi size={25} color="green" /></p>
            </div>
            ...
            <div className="p-4 pb-6 grid grid-col-1 md:grid-cols-2">
                ...
                <WorkCard
                    ...
                    href="movieflix"
                >
                    Aplicação full stack web, construida para treinar os conhecimentos do bootcamp da <a href="https://devsuperior.com.br/" target="_blank" rel="noreferrer" className="text-[#3D7AED] dark:text-pink-400 hover:underline">DevSuperior</a>.
                </WorkCard>
            </div>
        </Layout >
    )
